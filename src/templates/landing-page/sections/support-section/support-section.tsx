...
export const SupportSection = () => {
  return (
    <section className="relative pb-8 md:py-10 bg-gray-700">
      <div
        className="absolute inset-0 hidden md:block bg-[url('/background-features.svg')]
      ...
      rounded-lg p-6 md:p-12 bg-blue-400"
          >
            <div
        ...
        bg-blue-300 mb-4"
            ...
            <p className="text-body-sm text-gray-200">
              Adicione sua logo, favicon, cores no seu catálago e tenha tudo com
              a sua cara.
            </p>
          </div>
          ...
          <div
            className="flex flex-col text-left gap-2 
      rounded-lg p-6 md:p-12 bg-cyan-300"
          >
            <div
              className="flex h-12 w-12 items-center justify-center rounded-lg
        bg-cyan-200 mb-4"
