...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col text-gray-100 items-center justify-center px-4">
      ...
      <div className="relative inline-block mb-3 font-sans">
        <span
          className="text-8xl font-bold text-white inline-block transform 
        -rotate-12 -translate-y-2 -translate-x-1"
        >
          4
        </span>
        ...
        <span
          className="text-8xl font-bold text-white inline-block transform
        -rotate-45 translate-y-2 translate-x-2"
        >
          4
        </span>
      </div>
